    ...
    <div className="section-shell">
      ...
      <div className="mt-24 grid gap-5 md:grid-cols-3">
        {[
          ...
          <motion.div key={title} initial={{ opacity: 0, y: 35 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: .35 }} transition={{ delay: index * .12, duration: .6 }} whileHover={{ y: -7 }} className="group border-t border-white/10 pt-5 transition-colors hover:border-teal/50">
            <h3 className="text-xl font-bold text-white transition-colors group-hover:text-teal">{title}</h3>
