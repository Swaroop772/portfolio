...
const ProjectModal = ({ project, isOpen, onClose }) => {
    ...
    return (
        <AnimatePresence>
            {isOpen && (
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="fixed inset-0 z-[100] flex items-center justify-center p-3 sm:p-6" role="dialog" aria-modal="true" aria-labelledby="project-modal-title">
                    ...
                    <motion.div
                        ...
                        className="relative z-10 flex h-auto max-h-[calc(100dvh-1.5rem)] w-full max-w-4xl min-h-0 flex-col overflow-hidden rounded-3xl border border-white/10 bg-ink shadow-2xl shadow-black/40 sm:max-h-[90dvh]"
                    >
                        ...
                        <div className={`relative min-h-52 shrink-0 overflow-hidden border-b border-white/10 p-7 sm:min-h-64 sm:p-10 ${accentBg}`}>
